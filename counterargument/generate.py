...
Open by naming what their argument rests on, then put the source against it, then ask them to answer it.
...
def generate_challenge(student_warrant, parallel, student_claim=None,
                       model=MODEL, max_chunk_chars=1800):
    """
    ...
    user = "The student's argument rests on this rule:\n  " + student_warrant + "\n\n"
    if student_claim:
